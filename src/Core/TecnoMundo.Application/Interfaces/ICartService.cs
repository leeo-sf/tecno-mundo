...
namespace TecnoMundo.Application.Interfaces
{
    ...
    {
        Task<CartVO?> FindCartByUserId(Guid userId, string keyCache, DistributedCacheEntryOptions options);
        ...
        Task<bool> RemoveFromCart(Guid cartDetailsId, string keyCache, DistributedCacheEntryOptions options);
        Task<bool> ApplyCoupon(Guid userId, string couponCode, string keyCache, DistributedCacheEntryOptions options);
        ...
        Task<CartVO> SaveOrUpdate(CartVO vo, ProductVO productVO, string keyCache, DistributedCacheEntryOptions options);
    }
}
