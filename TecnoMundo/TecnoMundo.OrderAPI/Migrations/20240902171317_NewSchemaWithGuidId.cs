...
namespace TecnoMundo.OrderAPI.Migrations
{
    ...
    public partial class NewSchemaWithGuidId : Migration
    {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        purchase_amount = table.Column<decimal>(
                            type: "decimal(65,30)",
                            nullable: false
                        ),
                        ...
                        last_name = table
                            .Column<string>(type: "longtext", nullable: false)
                            .Annotation("MySql:CharSet", "utf8mb4"),
                        purchase_date = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: false
                        ),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        OrderHeaderId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "ascii_general_ci"
                        ),
        ...
        {
            migrationBuilder.DropTable(name: "order_detail");

            migrationBuilder.DropTable(name: "order_header");
        }
    }
}
